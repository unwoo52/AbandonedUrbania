...
namespace Lightbug.CharacterControllerPro.Core
{
    ...
    /// <summary>
    /// 이 클래스는 캐릭터 액터를 나타냅니다. 캐릭터 정보, 충돌 플래그, 충돌 이벤트 등
    /// 모든 캐릭터 관련 정보를 포함합니다. 
    /// 
    /// 또한 캐릭터의 이동, 회전, 순간 이동, 물리 연산, 몸 크기 조정 등과 같이
    /// 캐릭터와 관련된 모든 것의 실행 순서를 관리합니다.
    /// 
    /// 캐릭터가 2D 또는 3D 일 수 있으므로, 이 추상 클래스는 2D와 3D를 모두 구현해야합니다.
    /// </summary>
